    ...
    def _bootstrap(self) -> None:
        with self._pool.connection() as connection:
            ...
            for statement in (
                ...
                "ALTER TABLE scans ADD COLUMN IF NOT EXISTS multi_versions_json TEXT NOT NULL DEFAULT '[]'",
                "ALTER TABLE scans ADD COLUMN IF NOT EXISTS execution_agent_session_id TEXT NOT NULL DEFAULT ''",
                "ALTER TABLE scans ADD COLUMN IF NOT EXISTS execution_revision INTEGER NOT NULL DEFAULT 0",
                ...
                "ALTER TABLE vulnerability_validations ADD COLUMN IF NOT EXISTS execution_agent_session_id TEXT NOT NULL DEFAULT ''",
                "ALTER TABLE vulnerability_validations ADD COLUMN IF NOT EXISTS execution_revision INTEGER NOT NULL DEFAULT 0",
                "ALTER TABLE fp_review_jobs ADD COLUMN IF NOT EXISTS execution_agent_session_id TEXT NOT NULL DEFAULT ''",
                "ALTER TABLE fp_review_jobs ADD COLUMN IF NOT EXISTS execution_revision INTEGER NOT NULL DEFAULT 0",
                ...
                "ALTER TABLE vulnerabilities ADD COLUMN IF NOT EXISTS version_labels_json TEXT NOT NULL DEFAULT '[]'",
                "ALTER TABLE vulnerabilities ADD COLUMN IF NOT EXISTS version_locations_json TEXT NOT NULL DEFAULT '[]'",
